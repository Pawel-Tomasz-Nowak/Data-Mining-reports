...
## Brakujące wartości.
Ze wszystkich zmiennych dostępnych w ramce danych, jedynie zmienna *`r n.missing["variable"][1]`* zawiera brakujące wartości. Zawiera ich *`r n.missing["na.count"][1]`*. Wartości brakujące są kodowane standardowo, tj. jako *NA*.
