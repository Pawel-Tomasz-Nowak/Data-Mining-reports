...
```{r dropping irrelevant variables, include=FALSE, cache = TRUE}
dane <- dane %>%
...
# Lista zmiennych kategorycznych do wykresów
kategoryczne <- c("gender", "PhoneService", "InternetService", "OnlineSecurity")
...
grid.arrange(wykres("gender"), wykres("PhoneService"),
