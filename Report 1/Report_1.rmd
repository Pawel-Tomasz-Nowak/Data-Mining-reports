...
```{r comparing table, echo=FALSE, fig.cap="Porównanie wskaźników sumarycznych dla grup klientów lojalnych i odchodzących na podstawie zmiennej TotalCharges"}
library(kableExtra)
...
wskazniki <- wskazniki.dla.grup
tabela    <- rbind(wskazniki$No, wskazniki$Yes) 
