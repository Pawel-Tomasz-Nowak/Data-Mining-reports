...
```{r echo=FALSE, fig.width = 9, fig.height = 6, fig.cap = "Rozkłady zmiennych kategorycznych"}
wykres <- function(var){
...
```{r boxplots, echo=FALSE,fig.width = 9, fig.height = 6, fig.cap = "Wykresy pudełkowe zmiennych ciągłych"}
...
```{r histograms, echo=FALSE, fig.cap="Histogramy zmiennych ciągłych", fig.height=6, fig.width=9}
