...
```{r variance_comparison, echo=FALSE, fig.cap="Wykresy pudelkowe zmiennych ciągłych",fig.width = 9, fig.height  = 8}
...
```
Przyjrzyjmy się wykresowi \ref{fig:variance_comparison}. Obserwujemy wysokie zróżnicowanie wariancji. Z jednej strony w badanym zbiorze występują cechy o niskiej dewiacji, która charakteryzuje chociażby zmienną *Commute*. Z drugiej obecność takich zmiennych jak *Environmental.Quality* i *Venture.Capital* pokazują, że nie brakuję atrybutów o wysokiej wariancji..
