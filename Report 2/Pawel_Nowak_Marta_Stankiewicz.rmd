...
```{r PC variance visualization, fig.height =8, fig.width = 9, fig.cap = "Wykresy pudełkowe dla składowych głównych"}
...
```{r cum variances explained plot, fig.height=8, fig.width = 9, fig.cap = "Skumulowana wariancja wyjaśniana przez kolejne składowe główne"}
...
```{r PCA variances unstd, fig.width = 9, fig.height = 6, fig.cap = "Wykresy pudełkowe dla składowych głównych bez zastosowanej standaryzacji"}
...
```{r cum variances explained plot unstd, fig.height = 8, fig.width = 9,fig.cap = "Skumulowana wariancja wyjaśniana przez kolejne składowe główne"}
...
grouped_visualization <- function(var) {
  mds_df[[var]] <- titanic_data[[var]]
  
  ggplot(mds_df, aes(x = Dim1, y = Dim2, color = !!sym(var))) +
    geom_point(alpha = 0.8, size = 2) +
    labs(
      title = glue("MDS (k = 2): Wykres punktowy wg zmiennej '{var}'"),
      x = "Wymiar 1",
      y = "Wymiar 2",
      color = var
    ) +
