...
```{r silhouette comparison, include=TRUE}
library(cluster) 
library(clValid)
...
```{r accuracy, include=TRUE, tab.cap="Porównanie zgodności partycji dla metod AGNES oraz PAM"}
library(e1071)
library(cluster)


# Upewnij się, że true_labels zaczyna się od 1
...
# Upewnij się, że true_labels_matched to numeric 1,2,...
true_labels_matched <- as.numeric(as.factor(true_labels))

# Wyznaczenie etykiet klastrowania
...
# Dopasowanie klas — zwracają named vector, np. c("neg" = 1, "pos" = 2)
...
# Funkcja do mapowania liczbowych etykiet klastrów na nazwy z matched_
