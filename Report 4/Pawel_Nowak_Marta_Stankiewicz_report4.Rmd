...
labels_avg_matched <- matched_avg[labels_avg]
labels_single_matched <- matched_single[labels_single]
labels_complete_matched <- matched_complete[labels_complete]
labels_pam_matched <- matched_pam[labels_pam]
